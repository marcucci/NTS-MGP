...
To use this document, simply start at the [Table of Contents](nts_mpg_toc.md) file and begin browsing or you may search the repo for specific terms.

## Issues

If you find an issue in the document, please use the issue function above to log issues. Please be as detailed as possible and include refrences to the official NTS MPG to confirm the issue is valid.

## Contributing

We love contributions! Please feel free to contribute by submitting high quality PRs.

### Quick Start for Contributors

1. **Fork** the repository
2. **Clone** your fork: `git clone https://github.com/marcucci/NTS-MGP.git`
3. **Create** a branch: `git checkout -b change/amazing-change`
4. **Make** your changes
5. **Commit** your changes: `git commit -m 'Add amazing change'`
6. **Push** to your branch: `git push origin change/amazing-change`
...
### Core Team - Open to adding others!
